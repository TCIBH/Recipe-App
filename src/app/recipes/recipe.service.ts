...
export class RecipeService {
  ...
  private recipes: Recipe[] = [
    ...
    new Recipe(
      'The Crispy Fries',
      ' Freakin Hot Fries. Piping-hot french fries, crispy and more flavorful than any at those fast food joints.',
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS8t7Jy4Tkvw0peAsskJUnVjSJm4BxphU-PWM7v5-EJgw&s',
      [
